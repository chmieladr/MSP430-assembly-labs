...
TIMER_A0_Interrupt:                     ; adjusted for 64 samples (initialised as R6)
        ...
        mov     R14, BUFF(R4)           ; store the value in the buffer
...
skip_filter:
        ...
        mov     BUFF(R11), &DAC12_1DAT  ; moving unfiltered value to converter DAC_1 (only until the buffer isn't full for the first time)
...
finish:
        bic.w   #TAIFG, &TACTL          ; clear the interrupt flag
